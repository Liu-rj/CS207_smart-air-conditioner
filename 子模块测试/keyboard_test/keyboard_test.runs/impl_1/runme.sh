...
HD_PWD='D:/DigitalDesign/keyboard_test/keyboard_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kenboard_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kenboard_core.tcl -notrace

...
HD_PWD='D:/DigitalDesign/keyboard_test/keyboard_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kenboard_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kenboard_core.tcl
